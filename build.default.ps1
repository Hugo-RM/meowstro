...
# Only run this if you add/change dependencies or set up vcpkg for the first time:
# & "$VCPKG_PATH/vcpkg.exe" install sdl2 sdl2-image sdl2-mixer[mpg123] sdl2-ttf --triplet=x64-windows
